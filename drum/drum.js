...
const processQuery = async (stt, query_id, proxy) => {
    ...
    const config = {
        ...
        headers: {
            ...
            'Origin': 'https://drumapi.wigwam.app',
            'Referer': 'https://drumapi.wigwam.app/',
    ...
    const claimFarm = async (stt) => {
        ...
        const claimFarmConfig = {
            method: 'post',
            url: 'https://drumapi.wigwam.app/api/claimFarm',
            headers: config.headers,
    ...
    const startFarm = async (stt) => {
        ...
        const startFarmConfig = {
            method: 'post',
            url: 'https://drumapi.wigwam.app/api/startFarm',
            headers: config.headers,
